...
namespace TWCore.Diagnostics.Log.Storages
{
    ...
    /// </summary>
    [SettingsContainer("SlackBotLog")]
    public class SlackBotLogStorage : SettingsBase, ILogStorage
    {
        ...
        /// </summary>
        public string TrackedChatsFilePath { get; protected set; } = "{0}_SlackBotLogChats".ApplyFormat(Core.ApplicationName);
        /// <summary>
