...
namespace TWCore.Cache.Storages
{
    ...
    public class LFUStorage : CacheCollectionStorage
    {
        ...
        /// </summary>
        /// <param name="capacity">Capacity of the storage</param>
        /// <param name="agePolicy">Aging policy</param>
        public LFUStorage(int capacity, int agePolicy) : base(new LFUCollection<string, (StorageItemMeta, SerializedObject)>(capacity, agePolicy)) { }
    }
}
