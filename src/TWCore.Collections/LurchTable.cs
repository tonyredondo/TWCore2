...
namespace TWCore.Collections
{
    ...
    public class LurchTable<TKey, TValue> : IConcurrentDictionary<TKey, TValue>
    {
        ...
        public void Initialize()
        {
            lock (this)
            {
                ...
                for (int slot = 0; slot < FreeSlots; slot++)
                {
                    ...
                    if (index != slot + 1)
                        throw new Exception("The LurchTable internal datastructure appears to be corrupted.");
        ...
        /// <param name="fnUpdate">Delegate to update</param>
        /// <returns>Value added or updated</returns>
        ...
        /// </remarks>
        /// <param name="key">Item key</param>
        /// <param name="fnCreate">Delegate to add</param>
        /// <param name="fnUpdate">Delegate to update</param>
        /// <returns>Value added or updated</returns>
        ...
        /// </summary>
        /// <param name="key">Item key</param>
        /// <param name="createOrUpdateValue">Reference to the value for creation or update</param>
        /// <returns>true if the value was added or updated.</returns>
        ...
        /// </summary>
        /// <param name="key">Item key</param>
        /// <param name="fnCreate">Delegate for value creation</param>
        ...
        /// </summary>
        /// <param name="key">Item key</param>
        /// <param name="fnUpdate">Delegate for value update</param>
        ...
        /// </summary>
        /// <param name="key">Item key</param>
        /// <param name="fnCondition">Delegate for value deletion</param>
        ...
        /// </summary>
        /// <param name="key">Item key</param>
        /// <param name="removeValue">Reference to the removed value</param>
        /// <returns>true if the value was removed.</returns>
        ...
        public struct Enumerator : IEnumerator<KeyValuePair<TKey, TValue>>
        {
            ...
            /// </summary>
            /// <returns>true if the enumerator had avanced; otherwise, false.</returns>
        ...
        public class KeyCollection : ICollection<TKey>
        {
            ...
            /// </summary>
            /// <param name="array">Key array</param>
            /// <param name="arrayIndex">Offset array index</param>
            ...
            public struct Enumerator : IEnumerator<TKey>
            {
                ...
                /// Advances the enumerator to the next element of the collection.
                /// </summary>
                /// <returns>true if the enumerator could advance; otherwise, false.</returns>
                public bool MoveNext()
                {
                    return _owner.MoveNext(ref _state);
                }
        ...
        /// </summary>
        /// <param name="value">Output KeyValuePair value as peek result</param>
        ...
        /// Removes the oldest entry in the collection based on the ordering supplied to the constructor.
        /// </summary>
        /// <param name="value">Output KeyValuePair value</param>
        ...
        /// Removes the oldest entry in the collection based on the ordering supplied to the constructor.
        /// </summary>
        /// <param name="predicate">Predicate to compare before dequeue</param>
        /// <param name="value">Output KeyValuePair value</param>
        /// <returns>False if no item was available</returns>
        /// <exception cref="System.InvalidOperationException">Raised if the table is unordered</exception>
