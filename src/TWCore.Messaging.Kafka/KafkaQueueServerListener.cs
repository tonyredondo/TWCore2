            ...
            try
            {
                ...
                switch (messageBody)
                {
                    case RequestMessage request when request.Header != null:
                        ...
                        var evArgs = new RequestReceivedEventArgs(_name, Connection, request, body.Length, SenderSerializer, Config.RequestOptions.ServerReceiverOptions.CancellationBeforeClientResponseTimeoutInSec);
