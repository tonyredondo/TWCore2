...
namespace TWCore.Messaging.Exceptions
{
    ...
    public class MessageQueueConnectionException : MessageQueueException
    {
        ...
        /// <param name="innerException">Inner exception</param>
        public MessageQueueConnectionException(string queueUri, Exception innerException = null) : base(string.Format("Message Queue '{0}' was not found.", queueUri), innerException) { }
    }
}
