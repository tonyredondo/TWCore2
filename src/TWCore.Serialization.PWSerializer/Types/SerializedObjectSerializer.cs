...
namespace TWCore.Serialization.PWSerializer.Types
{
    ...
    /// </summary>
    public struct SerializedObjectSerializer : ITypeSerializer<SerializedObject>
    {
        ...
        /// <returns>Object instance of the value deserialized</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public SerializedObject ReadValue(BinaryReader reader, byte type)
        {
        ...
        /// <returns>Object instance of the value deserialized</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public SerializedObject ReadValue(BinaryReader reader)
