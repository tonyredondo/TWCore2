...
namespace TWCore.Serialization.PWSerializer
{
    ...
    {
        private static readonly ObjectPool<byte[], BufferAllocator> BufferPool = new ObjectPool<byte[], BufferAllocator>();

        private struct BufferAllocator : IPoolObjectLifecycle<byte[]>
        {
