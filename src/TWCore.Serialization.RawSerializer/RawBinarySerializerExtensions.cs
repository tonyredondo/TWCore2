...
namespace TWCore.Serialization
{
    ...
    public static class RawBinarySerializerExtensions
    {
        ...
        public static MultiArray<byte> SerializeToRawBinary<T>(this T item) => Serializer.Serialize(item);
        /// <summary>
        ...
        /// <param name="value">RawBinary serialized object</param>
        /// <returns>Object instance</returns>
        public static T DeserializeFromRawBinary<T>(this MultiArray<byte> value) => Serializer.Deserialize<T>(value);
        /// <summary>
