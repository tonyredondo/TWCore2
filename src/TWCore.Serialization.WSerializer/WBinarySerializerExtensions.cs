...
namespace TWCore.Serialization
{
    ...
    public static class WBinarySerializerExtensions
    {
        ...
        public static MultiArray<byte> SerializeToWBinary<T>(this T item) => Serializer.Serialize(item);
        /// <summary>
        ...
        /// <returns>Object instance</returns>
        public static T DeserializeFromWBinary<T>(this MultiArray<byte> value) => Serializer.Deserialize<T>(value);
        /// <summary>
        ...
        public static void SerializeToWBinary<T>(this T item, Stream stream) => Serializer.Serialize(item, stream);
        /// <summary>
        ...
        public static void SerializeToWBinaryFile<T>(this T item, string filePath) => Serializer.SerializeToFile(item, filePath);
        /// <summary>
