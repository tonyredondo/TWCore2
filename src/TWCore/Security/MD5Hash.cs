...
namespace TWCore.Security
{
    ...
    {
        private readonly MD5 _hashAlgo;
        /// <inheritdoc />
        /// <summary>
        /// Hash algorithm used
        /// </summary>
        ...
        public MD5Hash() => _hashAlgo = MD5.Create();
    ...
    public static class MD5HashExtensions
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MultiArray<byte> GetHashMD5Bytes(this MultiArray<byte> bytes) => Hash.GetBytes(bytes);
        /// <summary>
        ...
        /// <returns>Byte array hash</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MultiArray<byte> GetHashMD5Bytes(this object obj) => Hash.GetBytes(obj);
        /// <summary>
        ...
        /// <returns>Byte array hash</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MultiArray<byte> GetHashMD5Bytes(this string text) => Hash.GetBytes(text);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Guid GetHashMD5Guid(this MultiArray<byte> bytes) => Hash.GetGuid(bytes);
        /// <summary>
