...
namespace TWCore.Security
{
    ...
    public static class SHA1HashExtensions
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static string GetHashSHA1(this MultiArray<byte> bytes) => Hash.Get(bytes);
        /// <summary>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MultiArray<byte> GetHashSHA1Bytes(this MultiArray<byte> bytes) => Hash.GetBytes(bytes);
        /// <summary>
        ...
        /// <returns>Byte array hash</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MultiArray<byte> GetHashSHA1Bytes(this object obj) => Hash.GetBytes(obj);
        /// <summary>
        ...
        /// <returns>Byte array hash</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MultiArray<byte> GetHashSHA1Bytes(this string text) => Hash.GetBytes(text);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Guid GetHashSHA1Guid(this MultiArray<byte> bytes) => Hash.GetGuid(bytes);
        /// <summary>
