...
namespace TWCore.Security
{
    ...
    public static class SHA384HashExtensions
    {
        ...
        /// <returns>Byte array hash</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MultiArray<byte> GetHashSHA384Bytes(this object obj) => Hash.GetBytes(obj);
        /// <summary>
        ...
        /// <returns>Byte array hash</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MultiArray<byte> GetHashSHA384Bytes(this string text) => Hash.GetBytes(text);
