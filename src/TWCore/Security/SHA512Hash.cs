...
namespace TWCore.Security
{
    ...
    {
        private readonly SHA512 _hashAlgo;
        /// <inheritdoc />
        /// <summary>
        /// Hash algorithm used
        /// </summary>
        public override string Algorithm { get; } = "SHA512";
        /// <inheritdoc />
        /// <summary>
        /// MD5 Hash implementation
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public SHA512Hash() => _hashAlgo = SHA512.Create();
        /// <inheritdoc />
        /// <summary>
    ...
    /// <summary>
    /// SHA512 Hash extensions
    /// </summary>
    public static class SHA512HashExtensions
    {
        /// <summary>
        /// Hash algorithm used by the extensions
        /// </summary>
        public static IHash Hash { get; } = new SHA512Hash();
        ...
        /// <returns>String hash</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static string GetHashSHA512(this object obj) => Hash.Get(obj);
        /// <summary>
        ...
        /// <returns>String hash</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static string GetHashSHA512(this string text) => Hash.Get(text);
        ...
        /// <returns>Guid hash</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Guid GetHashSHA512Guid(this object obj) => Hash.GetGuid(obj);
        /// <summary>
        ...
        /// <returns>Guid hash</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Guid GetHashSHA512Guid(this string text) => Hash.GetGuid(text);
    }
