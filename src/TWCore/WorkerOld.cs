...
namespace TWCore
{
    ...
    public class WorkerOld<T> : IDisposable
    {
        ...
        public WorkerOld(Action<T> action, bool startActive = true, bool ignoreExceptions = false, bool useOwnThread = true)
        {
        ...
        /// <param name="useOwnThread">Sets if the worker uses its own thread</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public WorkerOld(Func<bool> precondition, Action<T> action, bool startActive = true, bool ignoreExceptions = false, bool useOwnThread = true)
        {
            _queue = new ConcurrentQueue<T>();
        ...
        /// <param name="useOwnThread">Sets if the worker uses its own thread</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public WorkerOld(Func<T, Task> function, bool startActive = true, bool ignoreExceptions = false, bool useOwnThread = false)
        {
            _queue = new ConcurrentQueue<T>();
            _precondition = null;
            _func = function;
        ...
        /// <param name="useOwnThread">Sets if the worker uses its own thread</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public WorkerOld(Func<bool> precondition, Func<T, Task> function, bool startActive = true, bool ignoreExceptions = false, bool useOwnThread = false)
        {
            _queue = new ConcurrentQueue<T>();
            _precondition = precondition;
            _func = function;
