...
var LogsComponent = /** @class */ (function () {
    ...
    LogsComponent.prototype.ngOnInit = function () {
        ...
        if (this._queryParams.fromDate !== undefined) {
            initialDate[0] = Object(ngx_bootstrap_chronos_test_chain__WEBPACK_IMPORTED_MODULE_7__["moment"])(this._queryParams.fromDate, 'YYYY-MM-DD').toDate();
        }
        if (this._queryParams.toDate !== undefined) {
            initialDate[1] = Object(ngx_bootstrap_chronos_test_chain__WEBPACK_IMPORTED_MODULE_7__["moment"])(this._queryParams.toDate, 'YYYY-MM-DD').toDate();
        }
...
/* harmony import */ var ngx_bootstrap_chronos__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ngx-bootstrap/chronos */ "./node_modules/ngx-bootstrap/chronos/index.js");
/* harmony import */ var ngx_bootstrap_locale__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ngx-bootstrap/locale */ "./node_modules/ngx-bootstrap/locale.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
Object(ngx_bootstrap_chronos__WEBPACK_IMPORTED_MODULE_8__["defineLocale"])('en-gb', ngx_bootstrap_locale__WEBPACK_IMPORTED_MODULE_9__["enGbLocale"]);
var SearchComponent = /** @class */ (function () {
    ...
    SearchComponent.prototype.ngOnInit = function () {
        ...
        this._queryParams = Object.assign({}, this._activatedRoute.snapshot.queryParams);
        if (this._queryParams.fromDate !== undefined) {
            initialDate[0] = Object(ngx_bootstrap_chronos_test_chain__WEBPACK_IMPORTED_MODULE_4__["moment"])(this._queryParams.fromDate, 'YYYY-MM-DD').toDate();
        }
        if (this._queryParams.toDate !== undefined) {
            initialDate[1] = Object(ngx_bootstrap_chronos_test_chain__WEBPACK_IMPORTED_MODULE_4__["moment"])(this._queryParams.toDate, 'YYYY-MM-DD').toDate();
        }
        this.bsConfig = Object.assign({}, {
            containerClass: 'theme-dark-blue',
    ...
    SearchComponent.prototype.doSearch = function () {
        ...
        this._queryService.apiQueryByEnvironmentSearchBySearchTermGet(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].name, this.searchValue, this.bsValue[0], this.bsValue[1]).subscribe(function (data) {
            ...
            for (var i = 0; i < _this.searchResults.traces.length; i++) {
                var item = _this.searchResults.traces[i];
            ...
            for (var groupItem in groupObject) {
                if (groupObject.hasOwnProperty(groupItem)) {
                    _this.searchTraces.push(groupObject[groupItem]);
                }
            }
        });
    };
        ...
        for (var i = 0; i < value.length; i++) {
            ...
            if (item != null) {
                ...
                if (resObj[currentKey] !== undefined) {
                    var rObjItem = resObj[currentKey];
    ...
    TraceDetailsComponent.prototype.updateData = function () {
        ...
        this._queryService.apiQueryByEnvironmentTracesByGroupNameGet(_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].name, this.group).subscribe(function (lstTraces) {
            ...
            for (var i = 0; i < lstTraces.length; i++) {
                ...
                _this.items.push(Object.assign(item, { tagsArray: tags }));
            }
        });
    };
...
var TracesComponent = /** @class */ (function () {
    ...
    TracesComponent.prototype.ngOnInit = function () {
        ...
        if (this._queryParams.date !== undefined) {
            initialDate = Object(ngx_bootstrap_chronos_test_chain__WEBPACK_IMPORTED_MODULE_7__["moment"])(this._queryParams.date, 'YYYY-MM-DD').toDate();
        }
    ...
    TracesComponent.prototype.getTimeDiff = function (end, start) {
        return (Object(ngx_bootstrap_chronos_test_chain__WEBPACK_IMPORTED_MODULE_7__["moment"])(end).valueOf() - Object(ngx_bootstrap_chronos_test_chain__WEBPACK_IMPORTED_MODULE_7__["moment"])(start).valueOf()) / 1000;
    };
    // Private Methods
